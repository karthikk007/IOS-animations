//
//  CAGradientLayerListViewController.swift
//  animations
//
...
class CAGradientLayerListViewController: UITableViewController {
    
    var list: [(String, UIViewController.Type)] =
        [ ("Gradient Animation",                    AnimateGradientViewController.self) ]
